...
;
          if (!runningTests) {
            require("ember3-bootstrap4-template/app")["default"].create({"name":"ember3-bootstrap4-template","version":"0.0.0+04b78e6c"});
          }
